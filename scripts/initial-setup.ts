...
const initSetup = async () => {
  try {
    ...
    const adminEmail = "audit@grove.dev";
    ...
    if (existingAdmin.length === 0) {
      console.log("👤 Creating default admin user (audit@grove.dev)...");
    ...
    // Don't exit with 1 if it's postinstall, it might break pnpm install if DB isn't up
